...
namespace Divie
{
    public partial class Divie : Form
    {
        ...
        //private AudioControll audio1;
        //private VideoFileBuilder videoFileBuilder;
        ...
        private void Form1_load(object sender, EventArgs e)
        {
            ...
            //lyd
            //audio1 = new AudioControll();

            //kamera
            cam1 = new CamControll();
            cam1.newframeAvailable += new newFrameHandler(updateFrame); //Event
            cam1.initiate();
        ...
        private void updateFrame(object source, newFrameArgs e)
        {
            try
            { 
                Invoke(new Action(() =>
